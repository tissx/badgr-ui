...
export class BadgeImageComponent extends AbstractBadgeComponent {
	readonly greenCheckCircleUrl = preloadImageURL(
		require("../../../breakdown/static/scss/images/awarded-green-check-circle.svg") as string
	);
	readonly grayCheckCircleUrl = preloadImageURL(
		require("../../../breakdown/static/scss/images/awarded-gray-check-circle.svg") as string
	);
	readonly loadingBadgeUrl = preloadImageURL(
		require("../../../breakdown/static/images/badge-loading.svg") as string
	);
	readonly failedBadgeUrl = preloadImageURL(
		require("../../../breakdown/static/images/badge-failed.svg") as string
	);
	readonly emptyBadgeUrl = preloadImageURL(
		require("../../../breakdown/static/images/placeholderavatar.svg") as string
	);
