...
import { PathwayElementComponent } from "../pathway-element/pathway-element.component";
import { Issuer } from "../../models/issuer.model";
import { IssuerManager } from "../../services/issuer-manager.service";
import { BadgeSelectionDialog } from "../badge-selection-dialog/badge-selection-dialog.component";
import { CommonDialogsService } from "../../../common/services/common-dialogs.service";
import { RecipientGroupSelectionDialog } from "../recipientgroup-selection-dialog/recipientgroup-selection-dialog.component";
...
export class PathwayDetailComponent extends BaseAuthenticatedRoutableComponent implements OnInit, AfterViewInit {
	...
	doElementMove(
		...
		if (this.movingElement) {
			let oldParent = this.movingElement.parentElement;

			let movingElement = this.movingElement;
			this.movingElement = null;
