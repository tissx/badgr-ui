		...
		<main *bgAwaitPromises="[ issuerLoaded, badgeClassLoaded ]">
			...
			<header class="wrap wrap-light l-containerhorizontal l-heading">
				...
				<header class="heading">
					<div class="heading-x-text">
						...
						<p>
							Award badges to individuals below, or <a
			...
			>
				...
				<div class="l-formsection wrap wrap-well" role="group" aria-labelledby="heading-recipientinformation">
					<h3 class="l-formsection-x-legend title title-ruled" id="heading-recipientinformation">Recipient
						Information</h3>
					<div class="l-formsection-x-container">
						<div class="l-formsection-x-help">
							...
							<p class="text text-small">You can award a badge via a recipients email address, url, or telephone
								number.</p>
						...
						<div class="l-formsection-x-inputs">
							<div class="formfield">
								...
								></bg-formfield-text>
								<p class="text text-small2"><strong>Note</strong>: The Recipient Name will appear in the awarded badge
									in plain text.</p>
							</div>
							<div class="formfield">
							...
							<div class="l-formsection-x-checkbox" *ngIf="issueForm.controls.recipient_type.value == 'email'">
								<label class="formcheckbox" for="notifybyemail">
									<input name="notifybyemail" id="notifybyemail" type="checkbox"
												 [formControl]="issueForm.untypedControls.notify_earner">
				...
				>
					...
					<div class="l-formsection-x-container">
						<div class="l-formsection-x-help">
							...
							<p class="text text-small">
								This Badge is set to expire. You can edit the expiration date or remove this section if you don't want
								this award to expire.
							</p>
							<a class="button button-tertiaryghost"
								 href="https://support.badgr.io/pages/viewpage.action?pageId=2981918"
							...
							<div *ngIf="defaultExpiration && !expirationDateEditable" class="heading heading-small">
								<div class="heading-x-text">
									...
									<h1>
										...
										<button class="heading-x-edit" type="button" tabindex="0" (click)="expirationDateEditable = true">
											Edit
										</button>
									</h1>
								</div>
				...
				<div class="l-formsection l-formsection-span wrap wrap-well" role="group"
						 aria-labelledby="heading-addoptionaldetails">
					<h3 class="l-formsection-x-legend title title-ruled title-ruledadd" id="heading-addoptionaldetails">Add
						Optional Details</h3>
					<div class="l-formsection-x-container">
						<div class="l-formsection-x-inputs">
